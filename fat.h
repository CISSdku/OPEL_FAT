...
//
#define SD_PAGE_SIZE 4

#define CLUSTER_IN_PAGE     (SD_PAGE_SIZE*256)      //SD_PAGE_SIZE * 256;   //(SD_PAGE_SIZE * 1024 byte / 4 byte) 
#define CLUSTER_IN_BLOCK    (128)               //(512 / 4) 
#define BLOCK_IN_PAGE       (SD_PAGE_SIZE * 2)      // SD_PAGE_SIZE * 2;    //SD_PAGE_SIZE * 1024 / 512
//   
//------------------------------------------//
...
//#define CLUSTER_IN_PAGE		L:q

//-------------------------------------------//
//          Configuration Value
#define BX_REUPDATE_META_DIFFER 6 //Percentage

#define NUM_EVNET       5 // number of total Evnet Type

#define BX_NORMAL           0    
#define BX_NORMAL_EVENT         1          
#define BX_PARKING_EVENT        2
#define BX_MANUAL           3
#define BX_IMAGE            4
#define BX_ETC              9

#define NUM_EVNET_DIRECTORY         6 // number of total Evnet Type


#define NORMAL_AREA_RATIO           70 /* 70% of Total Size */
#define NORMAL_EVENT_AREA_RATIO         20          
#define PARKING_EVENT_AREA_RATIO        10
#define MANUAL_AREA_RATIO           1
#define IMAGE_AREA_RATIO            1
#define ETC_AREA_RATIO              7

//If you change this item, you should change "get_area_number" function in fatent.c
//Init Area Size
//
//
//----------------------------------------------------------------//
